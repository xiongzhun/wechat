<?php
/**
 * [WeiShiHui System] Copyright (c) 2016 WSHWX.COM
 * WeiShiHui is NOT a free software, it under the license terms, visited http://www.wshwx.com/ for more details.
 */
	...
	if($ispost) {
		...
		if(empty($error)) {
			...
			if($_POST['type'] == 'remote') {
				...
				if($ins['error']) {
					die('<script type="text/javascript">alert("链接微实惠更新服务器失败, 错误为: ' . $ins['error'] . '！");history.back();</script>');
				}
				$archive = $ins['files'];
				if(!$archive) {
...
VER;
			...
			if(file_exists(IA_ROOT . '/index.php') && is_dir(IA_ROOT . '/web') && file_exists($verfile) && file_exists($dbfile)) {
				...
				die('<script type="text/javascript">alert("你正在使用本地安装, 但未下载完整安装包, 请从微实惠官网下载完整安装包后重试.");history.back();</script>');
			}
...
function remote_install() {
	...
	$pars['type'] = 'install';
	$pars['product'] = '';
	$url = 'http://rrv2.wshwx.com/aip.php';
...
<html lang="zh-cn">
	<head>
		...
		<title>安装系统 - 微实惠微信营销系统CMS企业版</title>
		...
		<div class="container">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					<li role="presentation"><a href="http://www.wshwx.com">微实惠官网</a></li>
					<li role="presentation"><a href="http://bbs.wshwx.com">微实惠论坛</a></li>
				</ul>
			...
			<div class="footer" style="margin:15px auto;">
				<div class="text-center">
					<a href="http://www.wshwx.com">关于微实惠</a> &nbsp; &nbsp; <a href="http://www.wshwx.com">微实惠帮助</a> &nbsp; &nbsp; <a href="http://spf360.taobao.com">购买授权</a>
				</div>
				<div class="text-center">
				    Powered by 微实惠微信营销系统CMS企业版 © 2017-2018 
				</div>
			</div>
		</div>
	...
	echo <<<EOF
		<div class="panel panel-default">
			...
			<div class="panel-body" style="overflow-y:scroll;max-height:400px;line-height:20px;">
				<h3>版权所有 (c)2017-2018微实惠科技保留所有权利。 </h3>
				<p>
					感谢您选择微实惠 - 微信营销系统CMS企业版（以下简称微实惠，微实惠基于 PHP + MySQL的技术开发，全部源码开放。 <br />
					为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：
				</p>
				<p>
					<strong>一、本授权协议适用且仅适用于微实惠微信营销系统任何版本，微实惠官方对本授权协议的最终解释权。</strong>
				</p>
				<p>
					<strong>二、协议许可的权利 </strong>
					<ol>
						<li>您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。</li>
						<li>您可以在协议规定的约束和限制范围内修改微实惠源代码或界面风格以适应您的网站要求。</li>
				...
				<p>
					...
					<ol>
						...
						<li>未经官方许可，禁止在微实惠的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</li>
				...
				<p>
					...
					<ol>
						...
						<li>电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始确认本协议并安装微实惠，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</li>
...
function tpl_install_env($ret = array()) {
	...
	echo <<<EOF
		...
		<div class="alert alert-info">系统要求微实惠整个安装目录必须可写, 才能使用微实惠所有功能。</div>
		<div class="panel panel-default">
...
function tpl_install_finish() {
	...
	<div class="alert alert-success">
		恭喜您!已成功安装“微实惠-微信营销系统CMS企业版，您现在可以: <a target="_blank" class="btn btn-success" href="./web/index.php">访问网站首页</a>
	</div>
EOF;
	tpl_frame();
}
