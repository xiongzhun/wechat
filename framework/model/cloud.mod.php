...
define('APIHOST', 'http://v2.wshwx.com/pull.php');
...
function getDomain(){
        return str_replace('', '', strtolower($_SERVER['SERVER_NAME']));
    }
...
function cloud_build() { //检测系统版本信息
	...
	$dat = cloud_request('http://v2.wshwx.com/pull.php', $pars);
...
function cloud_download($path, $type = '') {
	...
	$dat = cloud_request('http://v2.wshwx.com', $pars, $headers, 300);
	if(is_error($dat)) {
